const AboutUsCM = () => {
  return (
    <section className="flex flex-row flex-wrap justify-center items-center w-[90%] py-8 md:py-12">
      <div className="flex flex-col w-[53%] p-4 gap-2 md:w-[40%] md:gap-4 md:p-12 bg-white rounded-2xl md:rounded-4xl">
        <p className="font-semibold text-sm md:text-4xl italic">Chairman's Message</p>
