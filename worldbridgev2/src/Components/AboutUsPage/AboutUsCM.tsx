const AboutUsCM = () => {
  return (
    <section className="flex flex-row flex-wrap justify-center items-center w-[90%] py-8 md:py-12">
      <div className="flex flex-col w-[52%] p-4 gap-2 md:w-[40%] xl:w-[35%] md:gap-4 md:p-12 xl:py-24 bg-white rounded-2xl md:rounded-4xl">
      ...
      <div className="w-[48%] md:w-[40%] xl:w-[35%]">
